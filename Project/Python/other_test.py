debug_file_url = r'D:\Visual_Studio_Code\project\Project\Python\create_table.sql'
...
with open(debug_file_url, 'r', encoding='utf-8') as file:
    for line in file.readlines():
        ...
        #         xxxxx.append(x)
        #     column_type = xxxxx[1]
        #     if int(column_type[column_type.index('(')+1: len(column_type)-1]) > 3072:
        #         print(column_type)
