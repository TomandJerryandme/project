"""
https://github.com/Yang-Jianlin/Download_Video/blob/master/getVideo.py
    ...
    def spl_file(self):
        ...
        with open('data.txt', 'r', encoding='utf-8') as fp:
            ...
            while True:
                ...
                with open(filename, 'a', encoding='utf-8') as fp1:
                    fp1.write(link)
                flag += 1
            ...
            with open(filename, 'r', encoding='utf-8') as fp:
                while True:
                    ...
                    if link[:4] != "#EXT":  # 提取出下载链接的行
                        if link[:4] != 'http':
                        # if link[:4] != 'hhtp' and not link[:len(link) - 1].startswith('http'):
